...
const pageWName = '页面宽度',
    ...
    aWithoutFilterSelectors = { 'monsnode.com': '.iscroll>.jscroll-inner>center' },
    aWithoutFilterSelector = aWithoutFilterSelectors[window.location.host],
    contentSpecifyWidth = {
        'zcool.com.cn': 1440
    };
...
style.innerHTML = `
    ...
    body.${bodyClass}{
      padding-right:${pageW * scaleK}px!important;
...
function settingA() {
    ...
    console.log(aWithoutFilterSelector, [...document.querySelectorAll(aWithoutFilterSelector + ' a , ' + aWithoutFilterSelector)]);

    if (aWithoutFilterSelector) {
        console.log([...document.querySelectorAll(aWithoutFilterSelector + ' a ')]);
        [...document.querySelectorAll(aWithoutFilterSelector + ' a')]
